 ...
 * ```
 */
export type HybridRef<Props extends HybridViewProps, Methods extends HybridViewMethods = {}, Platforms extends ViewPlatformSpec = {
    ios: 'swift';
    android: 'kotlin';
 ...
 */
interface HybridViewTag<Platforms extends ViewPlatformSpec> extends HybridObject<Platforms> {
}
/**
