...
// This is a Rust-based `HybridObject`.
// Since it inherited from the `SharedTestObjectProps` interface,
// it will be flattened out and every property/method will be added here.
export interface TestObjectRust
  extends HybridObject<{ ios: "rust"; android: "rust" }>,
    SharedTestObjectProps {
  // Type-specifics
  readonly thisObject: TestObjectRust;
  newTestObject(): TestObjectRust;
  optionalHybrid?: TestObjectRust;
  getVariantHybrid(variant: TestObjectRust | Person): TestObjectRust | Person;
}
