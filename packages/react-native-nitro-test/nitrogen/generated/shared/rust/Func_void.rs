...
/// FFI-safe wrapper for callback `Func_void`.
///
...
#[repr(C)]
pub struct Func_void {
    fn_ptr: unsafe extern "C" fn(*mut std::ffi::c_void),
...
unsafe impl Send for Func_void {}
unsafe impl Sync for Func_void {}
