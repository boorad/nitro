...
/// FFI-safe wrapper for callback `Func_void_double`.
///
...
#[repr(C)]
pub struct Func_void_double {
    fn_ptr: unsafe extern "C" fn(*mut std::ffi::c_void, f64),
...
unsafe impl Send for Func_void_double {}
unsafe impl Sync for Func_void_double {}

impl Func_void_double {
...
impl Drop for Func_void_double {
    fn drop(&mut self) {
        unsafe {
