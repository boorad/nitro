//
// Func_void_std__exception_ptr.rs
...
/// FFI-safe wrapper for callback `Func_void_std__exception_ptr`.
///
...
#[repr(C)]
pub struct Func_void_std__exception_ptr {
...
unsafe impl Send for Func_void_std__exception_ptr {}
unsafe impl Sync for Func_void_std__exception_ptr {}

impl Func_void_std__exception_ptr {
...
impl Drop for Func_void_std__exception_ptr {
    fn drop(&mut self) {
        unsafe {
